...
CREATE TABLE `default_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_default_messages_category` (`category`),
  KEY `idx_default_messages_created_by` (`created_by`),
  CONSTRAINT `fk_default_messages_admin` FOREIGN KEY (`created_by`) REFERENCES `chat_admins` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2025-07-21 16:25:59
