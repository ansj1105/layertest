...
CREATE TABLE `chat_room_tags` (
  ...
  KEY `fk_room_tags_tag` (`tag_id`),
  CONSTRAINT `fk_room_tags_room` FOREIGN KEY (`room_id`) REFERENCES `chat_rooms` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_room_tags_tag` FOREIGN KEY (`tag_id`) REFERENCES `chat_tags` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-07-21 16:26:23
