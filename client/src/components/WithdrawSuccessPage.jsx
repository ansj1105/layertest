// 📁 components/WithdrawSuccessPage.jsx
  ...
  return (
    <div className="min-h-screen bg-[#1a1109] text-yellow-100 p-4">
      ...
      <ul className="space-y-3 text-sm">
        <li className="bg-[#1f2f1f] p-4 rounded">2025-04-20 | 150 USDT | 완료</li>
        <li className="bg-[#1f2f1f] p-4 rounded">2025-04-18 | 300 USDT | 완료</li>
      </ul>
    </div>
  );
}
