...
export default function AgencyCooperationPage() {
  ...
  //   "subTitle": "상담원 협력",
  //   "lines": [
  //     "Upstart의 팀 프로그램에 가입하여 Upstart을 홍보하고 커미션을 벌어보세요. Upstart의 편리함과 지속가능성을 누구보다 누릴 수 있습니다.",
  //     "Upstart은 각 사용자에게 넉넉한 팀 커미션 보상 메커니즘을 제공합니다.",
  //     "세 단계의 커미션 보상을 받을 수 있습니다: (이전은 Upstart이 당신에게 주는 추가 보상이며, 팀 멤버에게 상가되지 않습니다)",
